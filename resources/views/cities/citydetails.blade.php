...
<p id="pageName" hidden >Other</p>
	...
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" data-interval="false">
      ...
      <div class="item active srle">
	      <img src="{{ url('/uploads/cities') }}/{{$city->mainpic}}" style="width:1600px ;height: 800px;" alt="1.jpg" class="img-responsive">
	      <div class="carousel-caption">
	      </div>
	    </div>
      @foreach ($city->photos as $photo)
	    <div class="item">
	      <img src="{{ url('/uploads/cities') }}/{{$photo->path}}" style="width:1600px ;height: 800px;" alt="1.jpg" class="img-responsive">
	      <div class="carousel-caption">
	      </div>
	    </div>
      @endforeach
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" data-dismiss="modal" id="dd" class="btn btn-primary saveComment">Save </button>
      </div>
    </div>
  </div>
</div>
...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    $('.saveComment').click(function(e){
	    	...
	    	var cityId = '{{$city->id}}';
	    	var url = "{{route('City_addquestion')}}";
	    	e.preventDefault();
			...
			$.ajax({
				type:"POST",
				url: url,
				data : {cId: cityId, data: commentText, title: textTitle },
				success: function() {
					location.reload();
				}
			});
	    ...
	    $('.saveAnswer').click(function(e){
	    	...
	    	var url = "{{route('City_addanswertoquestion')}}";
	    	e.preventDefault();
			$.ajaxSetup({
				headers: {
					'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
