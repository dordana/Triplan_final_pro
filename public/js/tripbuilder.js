...
function subNumOfattractions(){
	var num_of_attractions_max = parseInt($("#num_of_attractions").text());
	$("#num_of_attractions").text(num_of_attractions_max - 1);
}

function addbNumOfattractions(){
	var num_of_attractions_max = parseInt($("#num_of_attractions").text());
	$("#num_of_attractions").text(num_of_attractions_max + 1);
}